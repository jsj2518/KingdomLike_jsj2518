...
public class HostileNPCState_Wander : HostileNPCStateBase
{
    public HostileNPCState_Wander(HostileNPC allyNPC) : base(allyNPC)
    {
    }
    ...
    public override void Enter()
    {
        ...
        waitTime = Random.Range(NPC.MonsterData.waittimemin, NPC.MonsterData.waittimemax);
    }
    ...
    public override void Execute()
    {
        switch (sequence)
        {
            ...
            case Sequence.Walk:
                ...
                {
                    NPC.transform.position = Vector3.MoveTowards(NPC.transform.position, destination, NPC.MonsterData.walkspeed * Time.deltaTime);
                }
                else
                {
