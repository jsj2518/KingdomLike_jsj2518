...
public class AllyNPCAnimatorController
{
    ...
    [SerializeField] private string workName = "Work";
    ...
    private static int hashWorkBool;
    ...
    public void Initialize(Animator _animator)
    {
        ...
        if (hashLoad == false)
        {
            ...
            hashWorkBool = Animator.StringToHash(workName);
    ...
    {
        animator.SetBool(hashWorkBool, work);
    }
